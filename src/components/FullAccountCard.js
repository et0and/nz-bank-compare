...
const AccountCard = ({ account }) => {
  ...
  return (
    <div className={`flex flex-col min-h-screen px-4 md:px-24 py-8 md:py-24 ${inter.className}`}>
      ...
      <div className="border-2 border-black dark:border-white p-8 mx-auto w-full md:w-3/4 lg:w-1/2">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <h1 className="text-2xl text-center font-bold mb-4 md:mb-0">{account.total_interest}% p.a.</h1>
          <div className="border-l-2 border-black dark:border-white h-full md:w-px md:mx-8"></div>
      ...
      <a href={account.url} className="text-center text-black-500 dark:text-white-500 hover:underline">Learn More ↗</a>
    </div>
  );
};
